    ...
    <>
      ...
      <aside
        className={cn(
          ...
          "fixed inset-y-0 left-0 z-50 w-72 bg-white dark:bg-surface-900 shadow-2xl",
          "transition-transform duration-300 ease-in-out",
          // Desktop: static in the flex layout, no shadow
          "lg:static lg:inset-y-auto lg:z-auto lg:w-64 lg:shadow-none lg:translate-x-0 lg:border-r dark:border-surface-700",
          open ? "translate-x-0" : "-translate-x-full"
        )}
      >
        {/* Mobile header row with close button */}
        <div className="flex items-center justify-between border-b dark:border-surface-700 px-4 py-3 lg:hidden">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-surface-900 dark:text-surface-50">TaskFlow</span>
          </div>
          <button
            onClick={onClose}
            className="flex h-8 w-8 items-center justify-center rounded-lg text-surface-400 dark:text-surface-500 hover:bg-surface-100 dark:hover:bg-surface-800 hover:text-surface-600 dark:hover:text-surface-400"
          ...
          {stats && (
            <div className="mb-6 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="rounded-lg bg-brand-50 dark:bg-brand-950/40 p-3">
                  <div className="text-2xl font-bold text-brand-700 dark:text-brand-400">
                    {stats.currentStreak}
                  </div>
                  <div className="text-xs text-brand-600 dark:text-brand-500">Day streak</div>
                </div>
